...
<form  action="<?php echo  $_SERVER['PHP_SELF'] ?>" method="post">
    ...
    <button type="submit" name="submit" class="btn btn-success">ارسال المعلومات</button>
  ...
  بالضغط على هذا الخيار فانت توافق على تسجيل معلوماتك في قاعدةالبيانات الخاصة بهذا النموذج فقدط حيث لم يتم استخدام هذا المعلومات في اي مكان اخر ولا يحق لاي جهة شراء او بيع 
  او تبادل هذه المعلومات الا بعد الموافقة الشخصية بعد ارسال بريد الالكتروني يوضح كيفيةاستخدام هذا المعلومات
  </label>
</div>
</div>
    ...
    <div class="d-grid gap-2 col-6 mx-auto my-5">
        <button id="winner" type="button" class="btn btn-danger" >
            اختيار الرابح
        </button>
